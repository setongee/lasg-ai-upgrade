      ...
      <Container>
        <div className="emptySide">
          <div className="textSide">
            <h1 className="!font-semibold">Sorry, we couldn't find that page.</h1>
            <span>
              Head over to the <a href="/">Lagos State Official Homepage</a>, or explore some of our
              services below.
            </span>
          </div>
          ...
          <div className="servicesSide flex">
            <div className="serviceSideItem">
              ...
              <div className="contentSide">
                ...
                <div className="subServices">
                  {' '}
                  Everything about tax payment in Lagos state, how to pay, where to pay, types of
                  taxes and more.{' '}
                </div>
            ...
            <div className="serviceSideItem">
              ...
              <div className="contentSide">
                ...
                <div className="subServices">
                  Know more about Lagos State Health Insurance, Request an ambulance, find the
                  nearest hospital.
                </div>
            ...
            <div className="serviceSideItem">
              ...
              <div className="contentSide">
                ...
                <div className="subServices">
                  {' '}
                  LASBCA Certificate verification, Property listing, LBIC application form, Opal
                  Membership.{' '}
                </div>
            ...
            <div className="serviceSideItem">
              ...
              <div className="contentSide">
                ...
                <div className="subServices">
                  {' '}
                  Find out more about benefits rendered to citizens by Lagos State Government.{' '}
                </div>
