...
export default function HomepageSlider() {
  ...
  const NewsMobile = [
    {
      ...
      date: 'Tues. 06 April, 2024',
      photo:
        'https://images.unsplash.com/photo-1589797688224-5fc840fa09e5?q=80&w=3540&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D',
      // photo : 'https://firebasestorage.googleapis.com/v0/b/lasg-a9f5c.appspot.com/o/IMG_1282%20(2).jpg?alt=media&token=7708e0a3-5211-411b-b2c4-fbda2c88cd4c'
    },
  ...
  const prevShow = () => {
    if (news !== 0) {
      ...
      document.querySelector('.newsPhotoshop').scrollLeft +=
        document.body.scrollWidth * newsData.length;
      ...
      <div className="mobileHome">
        <Container>
          <div className="flashNews">
            {' '}
            <span>⚒️ 👷🏾</span> Happy Workers Day - Stay rested!{' '}
          </div>
          ...
          <div className="buttons">
            ...
            <a href="#news" className="btnPrimary">
              {' '}
              Latest News{' '}
            </a>
          </div>
            ...
            <div className="coreItem">
              ...
              <div className="fillUp flex flex_justify_space_between flex_align_center">
                <div className="actionBtn flex thick">
                  ...
                  <a href="#services" className="button button2">
                    {' '}
                    Explore Services{' '}
                  </a>
                </div>
