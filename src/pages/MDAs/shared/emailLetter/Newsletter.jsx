  ...
  return (
    <div className="newsletter-section flex justify-center items-center bg-[#2e7d32] rounded-[10px] p-[30px] md:p-[50px] lg:p-[80px] my-[70px] md:my-[100px] mb-[50px] overflow-hidden relative">
      <img
        src={bgb}
        alt=""
        className="newsletter-bg w-full h-full object-cover absolute top-0 left-0"
      />

      <div className="newsletter-inner flex flex-col lg:flex-row items-center justify-between w-full text-white gap-[30px]">
        {/* Left section - Title */}
