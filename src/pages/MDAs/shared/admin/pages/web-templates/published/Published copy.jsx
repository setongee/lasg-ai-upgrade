...
import { Check, Edit, Eye, NavArrowDown, Plus } from 'iconoir-react';
      ...
      >
        <div className="titleAdmin z-10 flex items-center justify-between w-full h-[65px] px-6 border-b border-gray-200">
          ...
          <div className="flex items-center gap-3 relative">
            ...
            <button className="px-4 py-2 text-sm font-medium text-white bg-green-600 border border-transparent rounded-md hover:bg-green-700 focus:outline-none cursor-pointer">
              Publish Changes
            </button>
          </div>
        </div>
        ...
        >
          <ThemeSelector theme={theme} isEdit={true} />
        </div>
      </div>
