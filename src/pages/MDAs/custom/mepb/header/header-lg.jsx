    ...
    <div className={`w-full p-2 flex items-center justify-between ${customClass}`}>
      ...
      >
        <div
          ...
          onClick={() => page !== 'draft' && navigate(`/${mda}`)}
        >
          Home
        </div>
        <div
          className={page === 'about' ? '!text-[#2e7d32] font-bold' : '!text-[#2d2d2d]'}
          onClick={() => page !== 'draft' && navigate(`/${mda}/about`)}
        >
          About
        </div>
        ...
        {mdaData?.resources?.length > 0 && (
          <div
            ...
            onClick={() => page !== 'draft' && navigate(`/${mda}/resources`)}
          >
            Resources
          </div>
        )}
        ...
        <div
          ...
          onClick={() => page !== 'draft' && navigate(`/${mda}/news?page=1`)}
        >
          Newsroom
        </div>
        <div
