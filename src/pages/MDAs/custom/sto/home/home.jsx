...
const Home = ({ isEdit }) => {
  ...
  // (e.g. onboarded before sto had its own theme-initial-data entry).
  const enabledSections = landingPage?.enabledSections ?? themeInitialData.sto.enabledSections;
  ...
  return (
    ...
    >
      ...
      {enabledSections?.heroSection && (
        <HeroSection
          style={landingPage?.hero_style || 'groundedSplit'}
      ...
      {/* divider */}
      <Wrapper customClass="h-[1px] w-full bg-gray-300/70 md:mt-20! lg:mt-0!">
        <div />
      </Wrapper>

      {/* Document Showcase (financial statements) */}
