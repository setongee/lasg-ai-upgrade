    ...
    <div className="newQuick">
      <div className="quick__controls flex">
        <div className="arrow__nav abs1" onClick={() => scrollRight('left')}>
          <div className="abs">
            <NavArrowLeft strokeWidth={0.7} />
          </div>
        </div>

        <div className="arrow__nav abs1" onClick={() => scrollRight('right')}>
          <div className="abs">
            <NavArrowRight strokeWidth={0.7} />
          </div>
        </div>
      </div>
      ...
      <Container>
        {!isMobile ? (
          <div className="quick__holder desktop py-25 pb-30" id="quick__holder">
            <div
              onClick={() => window.open('https://www.lagosresidents.gov.ng/')}
              className="quickId"
            >
              {' '}
              <img src={lasrra} alt="lasrra" />{' '}
            </div>
            <div onClick={() => window.open('https://ileraeko.com/')} className="quickId">
              {' '}
              <img src={ilera} alt="ilera eko" />{' '}
            </div>
            <div onClick={() => window.open('https://lagosride.com/')} className="quickId">
              {' '}
              <img src={lagride} alt="lagos ride" />{' '}
            </div>
          </div>
        ) : (
          <div className="quick__holder" id="quick__holder">
            ...
            >
              {' '}
              <img src={lassra_sm} alt="lasrra" />{' '}
            </div>
            <div onClick={() => window.open('https://ileraeko.com/')} className="mobile">
              {' '}
              <img src={ilera_sm} alt="ilera eko" />{' '}
            </div>
            <div onClick={() => window.open('https://lagosride.com/')} className="mobile">
              {' '}
              <img src={lagride_sm} alt="lagos ride" />{' '}
            </div>
          </div>
        )}
      </Container>
