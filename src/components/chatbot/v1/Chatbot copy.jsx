...
const Chatbot = () => {
  ...
  *(Relevance: ${(d.similarity * 100).toFixed(1)}%)*`
  ...
  return (
    <>
      <h1>Lola — Lagos State Services Assistant</h1>
      <h3>Trained by Lagos State Ministry of Information, Science and Technology</h3>

      <div id="response" style={{ minHeight: '300px', border: '1px solid #ccc', padding: '1rem' }}>
