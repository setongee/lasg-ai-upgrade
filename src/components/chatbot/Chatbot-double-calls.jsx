...
const Chatbot = ({ pageContext }) => {
  ...
  const [messages, setMessages] = useState([
    {
      role: 'assistant',
      content: `Hello! **${getTimeOfDayGreeting()}** I'm **Seth** - your AI assistant from the Lagos State Ministry of Information, Science and Technology.`,
    },
  ]);
...
Now generate 6 relevant and realistic questions for Lagos citizens.
...
`;
    async function generateInitialSuggestions() {
      ...
      try {
        ...
        const suggestions = await generateNewChatSuggestions(prompt, 6);
      ...
      {isChatOpen && (
        <div className="chatParent">
          ...
          <div className="chat-window" ref={chatWindowRef}>
            ...
            {/* {showScrollButton && (
              <div
                className={`scroll-arrow ${isStreaming ? 'pulsing' : ''}`}
